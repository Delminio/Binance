  ...
  if (!alerts.length) {
    return (
      <section className="alerts empty">
        Nenhum alerta disparado ainda. O sistema vai notificar quando houver movimentação relevante nas cinco moedas.
      </section>
    );
  }
  ...
  return (
    <section className="overview-panel">
      <div className="overview-header">
        <div>
          <h3>Central de leitura dos 5 gráficos</h3>
          <p>
            Esta caixa resume automaticamente o que está acontecendo no BTC, ETH, SOL, BNB e SPK com base nos candles mais recentes.
          </p>
        </div>
    ...
    <div className="page">
      <header className="hero">
        <div>
          ...
          <p>Painel profissional em preto com BTC, ETH, SOL, BNB e SPK em tempo real, zoom, tela cheia e leitura automática do mercado.</p>
        </div>
